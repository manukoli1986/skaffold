...
```
$ helm install --name my-app myapp
NAME:   my-app
...
my-app-myapp  0/1    1           0          0s

==> v1/Pod(related)
NAME                                     READY  STATUS             RESTARTS  AGE
my-app-myapp-cbd844855-mnmf4  0/1    ContainerCreating  0         0s

==> v1/Service
NAME                     TYPE          CLUSTER-IP     EXTERNAL-IP  PORT(S)       AGE
my-app-myapp  LoadBalancer  10.107.81.235  <pending>    80:32729/TCP  0s


NOTES:
1. Get the application URL by running these commands:
     NOTE: It may take a few minutes for the LoadBalancer IP to be available.
           You can watch the status of by running 'kubectl get --namespace default svc -w my-app-myapp'
  export SERVICE_IP=$(kubectl get svc --namespace default my-app-myapp -o jsonpath='{.status.loadBalancer.ingress[0].ip}')
...
==> v1/Deployment
NAME                     READY  UP-TO-DATE  AVAILABLE  AGE
my-app-myapp  1/1    1           1          50m

==> v1/Pod(related)
NAME                                      READY  STATUS             RESTARTS  AGE
my-app-myapp-6594849b98-79bbq  0/1    ContainerCreating  0         0s
my-app-myapp-cbd844855-tnktc   1/1    Running            0         29m

==> v1/Service
NAME                     TYPE          CLUSTER-IP      EXTERNAL-IP  PORT(S)       AGE
my-app-myapp  LoadBalancer  10.105.235.119  <pending>    80:32162/TCP  50m
...
1               Fri Jun 28 16:49:25 2019        SUPERSEDED      myapp-1.0.0  Install complete
2               Fri Jun 28 17:09:01 2019        DEPLOYED        myapp-2.0.0  Upgrade complete
...
REVISION        UPDATED                         STATUS          CHART                   DESCRIPTION
1               Fri Jun 28 16:49:25 2019        SUPERSEDED      myapp-1.0.0  Install complete
2               Fri Jun 28 17:09:01 2019        SUPERSEDED      myapp-2.0.0  Upgrade complete
3               Fri Jun 28 17:10:25 2019        DEPLOYED        myapp-1.0.0  Rollback to 1
...
my-app  4               Fri Jun 28 17:39:49 2019        DEPLOYED        myapp-2.0.0  1.0             default

$ helm package myapp
Successfully packaged chart and saved it to: C:\Users\Administrator\Desktop\vagrant\riskident\deployment\myapp-2.0.0.tgz


$ helm search myapp
NAME                    CHART VERSION   APP VERSION     DESCRIPTION
local/myapp  2.0.0           1.0             Chart for deploying version 2 flask application
```
